        ...
        <div className="max-w-3xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-10 space-y-8">
            ...
            <div className="border rounded-lg p-6 md:p-8">
              ...
              <div>
                <h3 className="text-sm font-bold mb-3">Partner Category</h3>
                <Controller
                  control={control}
                ...
                {errors.partnerCategory && (
                  <p className="mt-2 text-xs text-red-500">
                    {errors.partnerCategory.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="border rounded-lg p-6 md:p-8">
              ...
              <div className="space-y-5">
                <div>
                  <label className="text-sm font-bold" htmlFor="organizationName">
                    Organization Name
                  </label>
                  <input
                    id="organizationName"
                ...
                <div>
                  <label className="text-sm font-bold" htmlFor="yourRole">
                    Your Role
                  </label>
                  <input
                    id="yourRole"
                ...
                <div>
                  <label className="text-sm font-bold" htmlFor="areaOfFocus">
